...
+(NSString *)info
{
    ...
    {
        [result appendString:queryGLInteger(GL_MAX_TEXTURE_UNITS_ARB, NSLocalizedString(@"Max simultaneous textures",""))];
    }
    else
    {
        [result appendString:NSLocalizedString(@"Max simultaneous textures","")];
